...
const comerciosLocales = [
  {
    ...
    descripcion:
      "Arropa konponketak, neurrira egindako jantziak eta eraldaketak auzoaren bihotzean.",
  ...
  },
  {
    ...
    descripcion:
      "Oinetakoen konponketa artisaua, giltza kopiak eta larrua zaintzeko produktuak.",
    imagen: "/images/comercios/zapatos.jpg",
    barrio: "Erdialdea",
  },
  {
    id: 3,
    nombre: "Gros Tailerrak",
    tipo: "Mekanikaria / Tailerra",
    descripcion:
      "Mekanika orokorra, pneumatikoen berrikuspena eta zure ibilgailuaren mantentze osoa.",
  ...
  },
  {
    ...
    tipo: "Kapela-denda",
    descripcion:
      "Espainiako kapela-dendarik zaharrena. Euskal txapelak eta kalitate handiko kapelak 1838tik.",
  ...
  },
  {
    ...
    tipo: "Artisautza",
    descripcion:
      "Bertako opariak eta oroigarri tradizionalak: eguzkiloreak, makilak eta erraldoiak.",
        ...
        <Container fluid className="mb-0 pb-0">
          <div className="text-center mb-4">
            ...
            <p className="subtitulo-seccion">
              Irristatu gure hiriaren esentzia ezagutzeko.
            </p>
          </div>
