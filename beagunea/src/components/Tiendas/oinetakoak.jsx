...
const comerciosData = {
  ...
  2: {
    ...
    biografia:
      "1949. urtean sortua, familiako negozio honek artisau-tradizioari eusten dio belaunaldiz belaunaldi. Gure tailerrean oinetako zaharrak berritzen ditugu maitasun handiz, eta larru onenarekin egindako produktuak eskaintzen ditugu. Zure oinen osasuna eta erosotasuna dira gure lehentasuna.",
    horarios: "Astelehenetik Larunbatera: 10:00 - 14:00 | 16:30 - 20:00",
    direccion: "Fermin Calbeton Kalea, 24, Parte Zaharra",
    telefono: "+34 943 11 22 33",
    productos: [
